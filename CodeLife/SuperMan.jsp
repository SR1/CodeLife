...
<%
	...
	//普通人滚粗！
	if(null==userInfo || hasSuperPower ==null || !hasSuperPower)
	{
        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            ...
            <ul class="nav pull-right">
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">正义之力：<%=(String)userInfo.get("username") %>的帐号 <b class="caret"></b></a>
			...
			<div class="span3 well">
				...
				<div class="row">
					<div class="span1 text-center " >
							粉丝<br/>
							<%=(String)userInfo.get("follower") %>
					</div>
					<div class="span1 text-center" >
							关注<br/>
							<%=(String)userInfo.get("folloed") %>
					</div>
					<div class="span1 text-center" >
							微博<br/>
							<%=(String)userInfo.get("message") %>
					</div>
				</div>
				<div class="row">
					<div class="span3">
